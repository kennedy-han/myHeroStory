package com.kennedy.herostory.login;

import com.kennedy.herostory.MySqlSessionFactory;
import com.kennedy.herostory.async.AsyncOperationProcessor;
import com.kennedy.herostory.async.IAsyncOperation;
import com.kennedy.herostory.login.db.IUserDao;
    ...
    private class AsyncGetUserByName implements IAsyncOperation {
        ...
        public void doAsync() {
            try (SqlSession mySqlSession = MySqlSessionFactory.openSession()) {
                ...
                // 但如果你听过前面的课,
                // 你可能会猜到这里面究竟发生了什么... :)
                //      Mybatis 使用javaassist 结合XML文件生成的字节码
